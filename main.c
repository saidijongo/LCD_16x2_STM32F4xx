...
/* USER CODE BEGIN PV */
uint32_t adc_value;
char direction[3] = "CW";  // Default direction is Clockwise
/* USER CODE END PV */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : DIR_Pin STOP_Pin BRAKE_Pin */
  GPIO_InitStruct.Pin = DIR_Pin|STOP_Pin|BRAKE_Pin;
